...
public interface Language {
	...
	/**
	 * This message is called when sender updated a {@link LimitedShop} permission.
	 *
	 * @param oldPermission old permission.
	 * @param newPermission new permission.
	 * @return The message in a specific language.
	 */
	String getUpdatedShopPermission(String oldPermission, String newPermission);

	/**
	 * This message is called when sender removed {@link LimitedShop} permission.
	 *
	 * @param oldPermission old permission.
	 * @return The message in a specific language.
	 */
	String getRemovedShopPermission(String oldPermission);

	/**
	 * This message is called when sender try to change permission by same permission.
	 *
	 * @param permission duplicate permission.
	 * @return The message in a specific language.
	 */
	String getShopAlreadyHasThisPermission(String permission);

	/**
	 * This message is called when player try to use a shop without th right permission.
	 *
	 * @param permission permission to use the {@link LimitedShop}.
	 * @return The message in a specific language.
	 */
	String getNeededPermission(String permission);

	/**
	 * This message is called when player interact with a limited shop to display his trade left.
	 *
	 * @param tradeLeft amount of items player can trade.
	 * @return The message in a specific language.
	 */
	String getLimitTracker(int tradeLeft);
	...
	/**
	 * This message is called when an error occurred when trying to load a {@link org.maxgamer.quickshop.api.shop.Shop}.
	 *
	 * @return The message in a specific language.
	 */
	 ...
	 * valid {@link org.maxgamer.quickshop.api.shop.Shop}.
	 *
	 * @return The message in a specific language.
	 */
